...
<div className="absolute top-1/2 left-1/3 transform -translate-x-1/2 -translate-y-1/2 text-center">
  ...
  <p className=" text-white sm:text-base text-sm mb-4">Kiire Internet, Sobilik Igale Saarlasele</p>
  <Link href="/internet" className="bg-gradient-to-r from-blue-950 from-50% to-indigo-900 text-xs sm:text-xl text-white px-2 py-2 hover:text-cyan-100 rounded-xl">Vaata Pakkumisi</Link>
</div>
